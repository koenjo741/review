...
# 1. ERST WIRD FLASK INITIALISIERT (Hier lag der Fehler)
app = Flask(__name__)
...
def initialize_work():
    ...
    # 2. Intelligentes Splitting für verkettete Literaturklumpen
